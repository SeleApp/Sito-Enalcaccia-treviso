        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Ente Nazionale Associazioni Libere della Caccia - 
              Promuoviamo la caccia responsabile e sostenibile in Italia.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="https://www.enalcaccia.it" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  Enalcaccia Nazionale
                </a>
              </li>
              <li>
                <a href="https://www.regione.veneto.it" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex">
              <Input
                ...
                className="flex-1 bg-gray-700 border-gray-600 text-white placeholder-gray-400 rounded-r-none"
                required
              />
